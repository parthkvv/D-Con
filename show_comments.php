...
;                    while($rows=$result->fetch_assoc()){
                ...
                if($result->num_rows>0){
                    while($rows=$result->fetch_assoc()){
                        ...
                        overflow: hidden;
                        position: relative;">
                        <div style=" color:black; postion: absolute;
                        left:50%;
                        top:50%;">
                        <p style="text-align:center;
                                        font-size:30px;
                        ...
                        echo '</p>';
                        echo '<div style=" margin:30px;"><form  action="delete_comment.php?comment_id='.$rows["Comment_id"].'&post_id='.$rows["Post_Id"].'" method="Post">
